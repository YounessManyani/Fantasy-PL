...
const config: AppConfig = {
  ...
  data: {
    csvPath: process.env.CSV_PATH || path.resolve(process.cwd(), 'src/models/data/fpl_player_statistics.csv'),
    fdrPath: process.env.FDR_PATH || path.resolve(process.cwd(), 'src/models/data/fdr_2025_26.json'),
